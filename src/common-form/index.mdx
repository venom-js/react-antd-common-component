...
import { Basic, Shrink, RowNum } from './demo/index';
import BasicDocz from './demo/docs/Basic.mdx';
import RowNumDocz from './demo/docs/RowNum.mdx';
import ShrinkDocz from './demo/docs/Shrink.mdx';
